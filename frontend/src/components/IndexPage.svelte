...
<div class="w-[100vw] h-[100vh] bg-base-500 flex flex-row">
  <div class="w-[80%] h-full flex flex-col gap-3">
    <HeaderBar addType="franchise" addFunction={() => {}} />
  ...
  <SideBar currentPage={SideBarPageEnum.FRANCHISES} />
</div>
